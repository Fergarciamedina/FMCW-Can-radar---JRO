	...
	<body>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" enctype="multipart/form-data" autocomplete="off">
				...
				<div class="form-group">
					<label for="pais" class="col-sm-2 control-label">Descripción</label>
					<div class="col-sm-10">
						<input type="pais" class="form-control" id="pais" name="pais" placeholder="pais" value="<?php echo $row['pais']; ?>"  required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="tel" class="form-control" id="ciudad" name="ciudad" placeholder="ciudad" value="<?php echo $row['ciudad']; ?>" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="tel" class="form-control" id="Fnacimiento" name="Fnacimiento" placeholder="Fnacimiento" value="<?php echo $row['Fnacimiento']; ?>" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="tel" class="form-control" id="Fdeceso" name="Fdeceso" placeholder="Fdeceso" value="<?php echo $row['Fdeceso']; ?>" >
					</div>
				</div>
				<!--
				<div class="form-group">
